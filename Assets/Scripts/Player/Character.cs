...
namespace PDXUnderground.Player
{
    ...
    /// </summary>
    public class Character : MonoBehaviour, IDamageable, IBuzzSystem, ICardSystem
    {
    // ICardSystem Events
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown if amount would exceed buzz boundaries</exception(amount);
    }
    /// <summary>
    ...
    {
        GameObject childObject = new GameObject("MyChildObject");
